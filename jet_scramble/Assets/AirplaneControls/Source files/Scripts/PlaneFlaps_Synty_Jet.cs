...
public class PlaneFlaps_Synty_Jet : MonoBehaviour {
    ...
    //public Transform wing_flap_right;
	...
	void Update () {
        ...
        //wing_flap_right.transform.rotation = Quaternion.Euler(45f * (planeMovement.currentAileronRotation / planeMovement.maxAileronRotation), 0, 0);
        ...
        //wing_flap_right.transform.localRotation = Quaternion.Euler(30 * (planeMovement.currentElevatorRotation / planeMovement.maxElevatorRotation), 0, 0);
