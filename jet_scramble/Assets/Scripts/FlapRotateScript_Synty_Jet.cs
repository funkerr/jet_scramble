...
public class FlapRotateScript_Synty_Jet : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            flap_l1.transform.DOLocalRotate(new Vector3(-40, 0, 0), 1, RotateMode.Fast);
        }
        else
        {
            flap_l1.transform.DOLocalRotate(new Vector3(0, 0, 0), 1, RotateMode.Fast);
        }

        if (Input.GetKey(KeyCode.A))
        {
            flap_r1.transform.DOLocalRotate(new Vector3(40, 0, 0), 1, RotateMode.Fast);
        }
        else
        {
            flap_r1.transform.DOLocalRotate(new Vector3(0, 0, 0), 1, RotateMode.Fast);
        }
        ...
        {
            flap_l1.transform.DOLocalRotate(new Vector3(30, 0, 0), 1, RotateMode.Fast);
        }
        else
        {
            flap_l1.transform.DOLocalRotate(new Vector3(0, 0, 0), 1, RotateMode.Fast);
        ...
        if (Input.GetKey(KeyCode.D))
        {
            flap_r1.transform.DOLocalRotate(new Vector3(-30, 0, 0), 1, RotateMode.Fast);
        }
        else
        {
            flap_r1.transform.DOLocalRotate(new Vector3(0, 0, 0), 1, RotateMode.Fast);
        ...
        if (Input.GetKey(KeyCode.Q))
        {
            ...
            rudder_left.transform.DOLocalRotate(new Vector3(0, 35, 0), 1);
        }
        else
        {
        ...
        {
            //Debug.Log("Pressed Q");
            rudder_right.transform.DOLocalRotate(new Vector3(0, 35, 0), 1);
        }
        else
        {
