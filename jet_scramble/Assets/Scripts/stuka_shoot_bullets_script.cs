...
public class stuka_shoot_bullets_script : MonoBehaviour
{
    [Foldout("Transforms")]
    public Transform bulletSpawnPoint_left;
    public Transform bulletSpawnPoint_right;
    public Transform spentShell_location;
    ...
    void Shoot()
    {
        ...
        if (Input.GetKey(KeyCode.Mouse0) && (allowFire))
        {
            ...
            bulletShellClone = Instantiate(spentShells, spentShell_location.transform.position, transform.rotation);
